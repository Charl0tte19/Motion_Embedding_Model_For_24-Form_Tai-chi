...
class ShiningLabel(qtw.QLabel):
    def __init__(self, text, parent=None):
        ...
        if os.name == 'posix':
            self.setFont(qtg.QFont('Noto Sans', 50))
        elif os.name == 'nt':
...
class MainWindow(qtw.QWidget):
    ...
    def __init__(self, cameraid=0):
        ...
        if os.name == 'posix':
            self.overlay_label.setFont(qtg.QFont('Noto Sans', 60))
        elif os.name == 'nt':
        ...
        self.webcam_thread = WebcamThread(self.cameraid)
    ...
    def show_score_page(self):
        ...
        if os.name == 'posix':
            self.score_label.setFont(qtg.QFont('Noto Sans', 50))
        elif os.name == 'nt':
        ...
        if os.name == 'posix':
            self.good_button.setFont(qtg.QFont('Noto Sans', 50))
        elif os.name == 'nt':
        ...
        if os.name == 'posix':
            self.ok_button.setFont(qtg.QFont('Noto Sans', 50))
        elif os.name == 'nt':
        ...
        if os.name == 'posix':
            self.bad_button.setFont(qtg.QFont('Noto Sans', 50))
        elif os.name == 'nt':
...
if __name__=="__main__":
    ...
    main_window = MainWindow(args.camera)
